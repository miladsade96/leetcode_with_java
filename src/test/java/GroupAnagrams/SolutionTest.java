...
class SolutionTest {
    ...
    void groupAnagrams() {
        ...
        Assertions.assertEquals(expected1, Solution.groupAnagrams(input1));

        List<String> input2 = List.of("a");
        List<List<String>> expected2 = new ArrayList<>();
        expected2.add(List.of("a"));
        Assertions.assertEquals(expected2, Solution.groupAnagrams(input2));

        List<String> input3 = List.of("");
        List<List<String>> expected3 = new ArrayList<>();
        expected3.add(List.of(""));
        Assertions.assertEquals(expected3, Solution.groupAnagrams(input3));
    }
}
